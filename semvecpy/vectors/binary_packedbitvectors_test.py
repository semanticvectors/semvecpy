...
from . import binary_packedbitvectors as bv
...
class TestBinaryVectors(TestCase):
    ...
    def test_generate_random(self):
        ...
        for i in range(1,100):
            ...
            meancard.append(bv.BinaryVector.getcount(binvec.bitset))
    ...
    def test_generate_zero(self):
        ...
        for i in range(1, 100):
            ...
            allcards.append(bv.BinaryVector.getcount(binvec.bitset))
    ...
    def test_set(self):
        basevec = bv.BinaryVectorFactory.generate_zero_vector(512)
        toadd = bv.BinaryVectorFactory.generate_random_vector(512)
        basevec.set(np.unpackbits(toadd.bitset.copy()))
        overlap = basevec.measure_overlap(toadd)
        basevec.tally_votes()
        overlap += basevec.measure_overlap(toadd)
